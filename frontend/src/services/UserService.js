...
class UserService {
    ...
    async assignRolesToUser(id, roles) {
        const response = await axios.post(API_URL + `api/users/${id}/roles`, roles);
        console.log('Assigned Role to User: ', response.data);
        return response.data;
    }

    async removeRolesFromUser(id, roles) {
        const response = await axios.delete(API_URL + `api/users/${id}/roles`, roles);
    ...
    async assignTravelPlanToUser(id, travelPlan) {
        const response = await axios.post(API_URL + `api/users/${id}/travelplans`, travelPlan);
    ...
    async removeTravelPlanFromUser(id, travelPlanId) {
        const response = await axios.delete(API_URL + `api/users/${id}/travelplans/${travelPlanId}`);
    ...
    async getUsersTraveling() {
        const response = await axios.get(API_URL + `api/users/traveling`);
    ...
    async getUserByTraveling(from, to) {
        const response = await axios.get(API_URL + `api/users/traveling/${from}/${to}`);
        console.log('User By Traveling: ', response.data);
        return response.data;
    }

    async getUsersWithRole(roleName) {
        const response = await axios.get(API_URL + `api/users/roles/${roleName}`);
        console.log('Users With Role: ', response.data);
        return response.data;
    }

    async getUsersWithPermission(permissionName) {
        const response = await axios.get(API_URL + `api/users/permissions/${permissionName}`);
        console.log('Users With Permission: ', response.data);
        return response.data;
    }

    async getRolesForUser(id) {
        const response = await axios.get(API_URL + `api/users/${id}/roles`);
        console.log('Roles For User: ', response.data);
        return response.data;
    }

    async getPermissionsForUser(id) {
        const response = await axios.get(API_URL + `api/users/${id}/permissions`);
