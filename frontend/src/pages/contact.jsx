...
const Contact = () => {
    return (<div className="grid place-items-center h-full mt-10">
        <div className="contact-container p-10">
            <div className="contact-left flex flex-col">
                <form className="contact-form" action="https://formspree.io/f/mgebgybw" method="POST">
                    <div className="contact-input-block">
                        <input className="contact-input bg-palette-dark-color-4" type="text" id="name" placeholder="Name"/>
                        <label htmlFor="text" className="hidden">Name</label>
                    </div>
                    <div className="contact-input-block">
                        <input className="contact-input" type="email" id="pass" placeholder="E-mail"/>
                        <label htmlFor="email" className="hidden">Email</label>
                    </div>
                    <div className="contact-input-block">
                        <input className="contact-input" type="phone" placeholder="Phone"/>
                    ...
                    <div className="contact-input-block">
                        <span className="contact-forgot text-center text-lg font-roboto italic">You are always free to call us at <span className="font-bold text-normal">03 123 456</span></span>
                        <button className="contact-button text-xl font-inder" type="submit">Submit</button>
                    </div>
                </form>
            </div>
